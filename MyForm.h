...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->grainsSelectedComboBox->SelectedIndexChanged += gcnew System::EventHandler(this, &MyForm::grainsSelectedComboBox_SelectedIndexChanged);
			// 
			// label10
			// 
			...
			this->gbAmountTextBox->TextChanged += gcnew System::EventHandler(this, &MyForm::gbAmountTextBox_TextChanged);
			// 
			// generateGBButton
			// 
